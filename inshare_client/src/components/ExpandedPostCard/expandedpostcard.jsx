...
const ExpandedPostCard = ({ post }) => {
    ...
    const fetchAuthor = async (userId) => {
        try {
            ...
            setAuthor(userData.name + " " + userData.surname);
    ...
    const handlePostComment = async () => {
        try {
            ...
            const response = await axios.post('http://localhost:5000/api/comment', newComment, config);
                    ...
                    <div>
                        ...
                        <div className={styles.cardfooter}>
                            <div className={styles.userinfo}>
                                ...
                                <span className={styles.postedTime} style={{ fontWeight: '450' }}><FaClock /> {timeAgo}</span>
