...
// Read all comments
router.get('/api/comments/all', async (req, res) => {
    try {
...
router.get('/api/comments/count/:postId', async (req, res) => {
    try {
...
// Upvote a comment
router.post('/api/comment/upvote/:id', authMiddleware, async (req, res) => {
    ...
    console.log('router.post(/api/comment/upvote/:id,authMiddleware:', tokenA);
...
router.post('/api/comment/downvote/:id', authMiddleware, async (req, res) => {
    ...
    // If 'Authorization' header is present, split it to get the token
    const tokenA = authHeader.split(' ')[1];
    console.log('router.post(/api/comment/downvote/:id,authMiddleware:', tokenA);
    console.log('req.params: ', req.params);
    console.log('req.user: ', req.user);
...
router.put('/api/comment/flag/:id', async (req, res) => {
    try {
        const { id } = req.params;
