...
// Upvote a post
router.post('/api/post/upvote/:id', authMiddleware, async (req, res) => {
    ...
    console.log('router.post(/api/post/upvote/:id,authMiddleware:', tokenA);
...
router.post('/api/post/downvote/:id', authMiddleware, async (req, res) => {
    ...
    // If 'Authorization' header is present, split it to get the token
    const tokenA = authHeader.split(' ')[1];
    console.log('router.post(/api/post/downvote/:id,authMiddleware:', tokenA);
    console.log('req.params: ', req.params);
    console.log('req.user: ', req.user);
...
router.put('/api/post/flag/:id', async (req, res) => {
    try {
        const { id } = req.params;
